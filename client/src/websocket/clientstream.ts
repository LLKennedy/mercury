...
export class ClientStream<ReqT extends ProtoJSONCompatible, ResT = any> extends StreamBase<ReqT, ResT> {
...
export interface IClientStream<ReqT extends ProtoJSONCompatible, ResT = any> extends ClientStream<ReqT, ResT> { }