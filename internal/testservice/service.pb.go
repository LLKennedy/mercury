...
func init() {
	proto.RegisterType((*FibonacciRequest)(nil), "httpgrpc.FibonacciRequest")
	proto.RegisterType((*FibonacciResponse)(nil), "httpgrpc.FibonacciResponse")
	proto.RegisterType((*RandomRequest)(nil), "httpgrpc.RandomRequest")
	proto.RegisterType((*RandomResponse)(nil), "httpgrpc.RandomResponse")
	proto.RegisterType((*UploadPhotoRequest)(nil), "httpgrpc.UploadPhotoRequest")
	proto.RegisterType((*UploadPhotoResponse)(nil), "httpgrpc.UploadPhotoResponse")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	,
}
...
func (c *serviceClient) Fibonacci(ctx context.Context, in *FibonacciRequest, opts ...grpc.CallOption) (*FibonacciResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/httpgrpc.Service/Fibonacci", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetRandom(ctx context.Context, in *RandomRequest, opts ...grpc.CallOption) (*RandomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/httpgrpc.Service/GetRandom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) PostUploadPhoto(ctx context.Context, in *UploadPhotoRequest, opts ...grpc.CallOption) (*UploadPhotoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/httpgrpc.Service/PostUploadPhoto", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Fibonacci_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/httpgrpc.Service/Fibonacci",
	}
...
func _Service_GetRandom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/httpgrpc.Service/GetRandom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_PostUploadPhoto_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/httpgrpc.Service/PostUploadPhoto",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
